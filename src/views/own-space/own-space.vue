...
export default {
  ...
  methods: {
    ...
    init() {
      console.debug(`debug - own-space - init`);
    },
  ...
  watch :{
    '$root.$store.state.user.info':function(){
      this.userForm.name = this.$root.$store.state.user.info.nickName;
      this.userForm.roleName = this.$root.$store.state.user.info.roleName;
      this.userForm.cellphone = this.$root.$store.state.user.info.mobile;
      this.initPhone = this.userForm.cellphone;
