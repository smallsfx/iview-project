...
export const appRouter = [
    ...
    },
    {
        ...
        component: Main,
        children: [
            { path: 'search', title: '订单查询', name: 'order-search', component: () => import('@/views/order/search.vue') }
        ]
    },
    {
        path: '/access-test',
...

    {
        ...
        children: [
            ...
            { path: 'log', title: '日志查询', name: 'logger-manage', component: () => import('@/views/System/log.vue') }
        ]
    },
    {
        path: '/error-page',
